...
#example of how the date ranges would be reformatted to include the correct range of dates
holiday=['2018-12-25','2018-09-03','2018-11-22']
finalspxrng=[]
spxday = pd.bdate_range(start='7/30/2018 09:30:00', end='12/31/2018 16:00:00', freq='C', holidays=holiday, normalize=False, weekmask='Mon Tue Wed Thu Fri', tz='America/New_York'); #create our own range using 15 min intervals
#print(len(spxday))
spxrng = pd.bdate_range(start='7/30/2018 09:30:00', end='12/31/2018 16:00:00', freq='15T', normalize=False, tz='America/New_York'); #create our own range using 15 min intervals
#print(spxrng.summary())
...
first8 = pd.bdate_range(start='7/30/2018 09:30:00', end='7/30/2018 10:30:00', freq='15T', normalize=False, tz='America/New_York'); 
last12 = pd.bdate_range(start='7/30/2018 13:00:00', end='7/30/2018 16:00:00', freq='15T', normalize=False, tz='America/New_York'); 
print(first8)
print(last12)
