...
for day in spxrng.date:
	if day in spxday.date and spxrng.time[count] >= datetime.time(9,30,0) and spxrng.time[count] <= datetime.time(16,0,0):
		#print(spxrng[count])
...
#for dt in spxrng:
#	print(dt)
#spx["Dates"] = spxrng; #apply our own range to the dataset
#print(spx);